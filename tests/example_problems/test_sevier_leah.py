...
class UpperSevier(unittest.TestCase):
    ...
    def build(self, date:str, test_message=''):
        ...
        # 1 BD. WR633018
        ''' On 7/25/23 the solver gave this a value of zero because ? 
        '''
        system.add_transaction(
            id = 1, 
            priority = 1, 
            upper_limit = season1 * 1.25, 
            apath = [{'factor':1,'flow_name':'>MonroeSouthBend'}], 
        ...
        system.add_transaction(
            ...
            child_series_name='BO-subseries')
        system.add_transaction(
            id=2002, 
            series_name='BO-subseries', 
            priority=2.1, 
            upper_limit=None, 
            apath=[{'factor':-1,'flow_name':'UpperReach>OtterCreekResv'}, {'factor':1,'flow_name':'>KingstonCombined'}],
        ...
        system.add_transaction(
            ...
            child_series_name='BA-subseries')
        system.add_transaction(
            id=3003, 
            series_name='BA-subseries', 
            priority=3.1, 
            upper_limit=None, 
            apath=[{'factor':-1,'flow_name':'UpperReach>OtterCreekResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>MonroeSouthBend'}],
        ...
        # WR61339/2251
        ''' 
        This is the diversion into storage. It has 3 parts:
            1st - Undiverted gaurentee under BO (AS_BO-BO)
            2nd - Undiverted gaurentee under BA (AS_BA-BA)
            3rd - Right to store a fraction of the flow (AL)
        '''
        system.add_transaction(
            id=2004, 
            series_name='BO-subseries', 
            priority=4, 
            upper_limit=None, 
            apath=[{'factor':-1,'flow_name':'UpperReach>OtterCreekResv'}, {'factor':1,'flow_name':'UpperReach>OtterCreekResv'}] # I think this should just be a transfer between accounts in OtterCreek Resrv
        )
        system.add_transaction(
            id=3004, 
            series_name='BA-subseries', 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'UpperReach>OtterCreekResv'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'UpperReach>PiuteResv'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>SValley'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Joseph'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Monroe'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Brooklyn'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Elsinore'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Richfield'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Annabella'}], 
        ...
        system.add_transaction(
            ...
            apath = [{'factor':1,'flow_name':'>Vermillion'}], 
        ...
        '''
        In the WCAT model, are these results part of the diversion through the canal or water put into storage?
        '''
        system.add_transaction(
            id = 90, 
            priority = 90, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>SValley'}], 
        ...
        system.add_transaction(
            ...
            priority = 91, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Joseph'}], 
        ...
        system.add_transaction(
            ...
            priority = 92, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>MonroeSouthBend'}], # Wells?
        ...
        system.add_transaction(
            ...
            priority = 93, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Monroe'}],
        ...
        system.add_transaction(
            ...
            priority = 94, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Brooklyn'}],
        ...
        system.add_transaction(
            ...
            priority = 95, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Elsinore'}],
        ...
        system.add_transaction(
            ...
            priority = 96, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Richfield'}],
        ...
        system.add_transaction(
            ...
            priority = 97, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Annabella'}],
        ...
        system.add_transaction(
            ...
            priority = 99, 
            upper_limit = None, 
            apath = [{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>LowerReach'}, {'factor':1,'flow_name':'>Piute'}],
        )
        ...
        system.add_transaction(
            ...
            apath=[{'factor':-1,'flow_name':'UpperReach>PiuteResv'}, {'factor':1,'flow_name':'UpperReach>OtterCreekResv'}]
        )
    ...
    def test_run_2023_and_summarize_as_csv(self):
        """
        Summarize the natural flow diversion and storage deliveries for each account.
        Save output as CSV.
        """
        ...
        mapping = {
            ...
            'TRXN_2002':'BO',
            'TRXN_3003':'BA',
            'TRXN_2004':'ES', # TRXN_2004 and TRXN_2004 and TRXN_4 should sum to ES
            'TRXN_3004':'ES',
            'TRXN_4':'ES',
            'TRXN_5':'FT',
            'TRXN_7':'BF',
        ...
        with open('test_run_2023_and_summarize_as_csv_3.csv', 'w') as f:
            
            if True: # Write header
                line = ['Date']
                for var_id in var_values['variables']:
                    line.append(var_id)
                    line.append('WCAT')
                    line.append('dif')
                f.write(','.join([str(x) for x in line]))

            for i, date in enumerate(var_values['dates']):
                line = [date]
                for var_id in var_values['variables']:
                    calc_value = var_values['variables'][var_id][i]
                    wcat_value = ''
                    dif_value = ''
                    if var_id in mapping:
                        wcat_value = self.get_value(mapping[var_id], date)
                        dif_value = calc_value - wcat_value
                    line.append(calc_value)
                    line.append(wcat_value)
                    line.append(dif_value)
    ...
    def test_combined_2023(self):
        from datetime import date, timedelta
        for d in (date(2023,7,4) + timedelta(n) for n in range(1)):
            yyyy_mm_dd = d.isoformat()
