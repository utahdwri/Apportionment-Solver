...
class LPSolver:
    ...
    def __init__(self):
        ...
        '''
        # Allow imprecise results? This would only work if we use the different ortools.linear_solver.python model_builder interface
        parameters = "change_status_to_imprecise:false" # GLOP finds optimal with this parameter!
        self.solver.set_solver_specific_parameters(parameters)
        '''
