...
from .kernel import (
    BlockLPError, LPKernel, ScalarFormulaKernel,
    compile_lp_kernel, compile_scalar_formula_kernel,
)
...
__all__ = [
    ...
    'compile_lp_kernel', 'compile_scalar_formula_kernel', 'LPKernel', 'ScalarFormulaKernel',
