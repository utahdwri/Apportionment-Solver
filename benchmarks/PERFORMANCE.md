...
This report covers the initial performance changes through `f51d32b`.
The later piecewise-loss implementation and its separate performance costs are
documented in [Piecewise-linear losses](../documentation/PIECEWISE_LOSSES.md).
